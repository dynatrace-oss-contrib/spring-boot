...
===== API v2
The v2 API can be activated by adding the version to the properties:
...
When using the Dynatrace v2 API, new features are available:
...
----
	management:
	  metrics:
	    export:
	      dynatrace:
            # ... token, uri, and api-version: "v2" ...
            metric-key-prefix: "your.key.prefix"
            enrich-with-oneagent-metadata: true
            default-dimensions:
              dimension1: "value1"
              dimension2: "value2"
----
