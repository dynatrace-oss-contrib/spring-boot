...
Note that the https://www.dynatrace.com/support/help/how-to-use-dynatrace/metrics/metric-ingestion/ingestion-methods/local-api/[local OneAgent endpoint] will have to be enabled first as stated in the documentation.
...
* Metric key prefix: Sets a prefix that will be prepended to all exported metric names.
