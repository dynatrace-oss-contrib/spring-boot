...
If no local OneAgent is running, the token and URI are required.
The https://www.dynatrace.com/support/help/dynatrace-api/basics/dynatrace-api-authentication/[API token] must have the `metrics.ingest` permission set.
